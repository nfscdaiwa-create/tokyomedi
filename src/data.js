...
export const UI = {
  'zh-hans': {
    ...
    strength:'日本医学研究与医疗发展', strengthLead:'介绍与现代医疗相关的代表性研究成果，并提供可核验来源，帮助用户理解日本医学研究的发展脉络。',
    medicineDb:'日本医药品资料库', medicineLead:'数据库是工具，不是商城。以名称、成分、类别和官方来源为核心组织。',
    why:'为什么选择 TOKYO MEDI', guides:'最新指南', travel:'赴日医疗资讯', inquiry:'就医与机构咨询', rx:'处方药品项展示',
  ...
  en: {
    ...
    strength:'Medical research and care in Japan', strengthLead:'Selected developments in Japanese medical research are presented with verifiable sources and connected to current medicine and hospital information.',
    ...
    why:'Why TOKYO MEDI', guides:'Latest guides', travel:'Medical travel', inquiry:'Care and institutional inquiry', rx:'Prescription reference',
  ...
  ja: {
    ...
    strength:'日本の医学研究と医療', strengthLead:'現代医療に関連する代表的な研究成果を、確認可能な情報源とともに紹介します。',
    medicineDb:'日本医薬品データベース', medicineLead:'ECではなくリファレンス。名称、成分、カテゴリー、一次情報を中心に整理します。',
    why:'TOKYO MEDIを選ぶ理由', guides:'最新ガイド', travel:'医療渡航情報', inquiry:'受診と機関向け照会', rx:'処方薬リファレンス',
